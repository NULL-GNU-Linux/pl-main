pkg = {
	name = "org.libc.musl.cross",
	version = "1.2.5",
	description = "musl libc cross toolchain.",
	maintainer = "NEOAPPS <neo@obsidianos.xyz>",
	license = "MIT",
	homepage = "https://musl.libc.org",
	depends = {},
	conflicts = {},
	provides = { "musl", "libc", "ld-linux", "cross-libc" },
	files = {},
}
...
function pkg.source()
	...
	return function(hook)
		hook("prepare")(function()
			...
			local url = "https://github.com/richfelker/musl-cross-make/archive/refs/heads/master.tar.gz"
		...
		hook("install")(function()
			...
			table.insert(pkg.files, ROOT .. "/usr/lib/musl/")
